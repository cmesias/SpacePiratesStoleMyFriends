...
void TileBar::load(SDL_Renderer *gRenderer) {
	gTileBar.loadFromFile(gRenderer, "resource/gfx/tileset.png");
	...
	//Load texture target
	gTargetTexture.createBlank( gRenderer, gTileBar.getWidth(), gTileBar.getHeight(), SDL_TEXTUREACCESS_TARGET );
